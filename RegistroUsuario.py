...
class VentanaRegistro(QMainWindow):
    ...
    def registrar(self):
        ...
        self.agregar_Usuario(nombre, apellido,nombreUsuario,contraseniaE,cargo)
    ...
    def agregar_Usuario(self,nombre, apellido,nombreUsuario,contrasenia,cargo):
        try:
            cursor = conexion.cursor()

            consulta = """
            INSERT INTO usuarios (nombre, apellido,contrasenia,cargo,usuario) 
            VALUES (%s, %s, %s,%s,%s)
            """
            datos = (nombre, apellido,contrasenia,cargo,nombreUsuario)
