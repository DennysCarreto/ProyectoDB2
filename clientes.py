...
class VentanaClientes(QMainWindow):
    def __init__(self):
        ...
        self.etiquetaD=QLabel("Dirección: ")
        layout_grid.addWidget(self.etiquetaD, 2, 0,1,1)
        self.setDireccion_cliente = QLineEdit(self)
        layout_grid.addWidget(self.setDireccion_cliente, 2, 1,1,1)
    ...
    def agregar_cliente_datos(self):
        ...
        direccion = self.setDireccion_cliente.text()
        telefono = self.setTel_cliente.text()
        self.agregar_cliente(nombre, apellido, direccion, telefono)
        self.setNombre_cliente.clear()
        self.setApellido_cliente.clear()
        self.setDireccion_cliente.clear()
    ...
    def actualizar_cliente_datos(self):
        ...
        direccion = self.setDireccion_cliente.text()
        telefono = self.setTel_cliente.text()
        self.actualizar_cliente(id,nombre, apellido, direccion, telefono)
        self.setNombre_cliente.clear()
        self.setApellido_cliente.clear()
        self.setDireccion_cliente.clear()
        self.setTel_cliente.clear()
    ...
    def eliminar_cliente_datos(self):
        ...
        direccion = self.setDireccion_cliente.text()
        telefono = self.setTel_cliente.text()
        self.eliminar_cliente(id,nombre, apellido, direccion, telefono)
        self.setNombre_cliente.clear()
        self.setApellido_cliente.clear()
        self.setDireccion_cliente.clear()
        self.setTel_cliente.clear()
    ...
    def agregar_cliente(self,nombre, apellido, direccion, telefono):
        try:
            ...
            conexion.commit()
            QMessageBox.information(self, "correct", "Cliente agregado correctamente")
    ...
    def mostrar_clientes(self):
        try:
            ...
            column_names = ['id','Nombre','Apellido','Direccion','Telefono']
            cursor.execute("SELECT id,nombre,apellido,direccion,telefono FROM cliente ")
    ...
    def buscar_cliente(self):
        ...
        try:
            ...
            if not conexion.is_connected():
                print("¡Error! La conexión no está activa.")
                return
            cursor.execute("SELECT nombre, apellido, direccion, telefono FROM clientes WHERE id_cliente = %s", (id,))
            result = cursor.fetchone()
            if result:
                nombre, apellido, direccion, telefono = result
                tel = str(telefono)
                self.setNombre_cliente.setText(nombre)
                self.setApellido_cliente.setText(apellido)
                self.setDireccion_cliente.setText(direccion)
    ...
    def actualizar_cliente(self, id_cliente, nombre, apellido, direccion, telefono):
        try:
            cursor = conexion.cursor()
            ...
            WHERE id_cliente = %s
            """
            datos = (nombre, apellido, direccion, telefono, id_cliente)
            cursor.execute(consulta, datos)

            conexion.commit()
            QMessageBox.information(self, "Correcto", "Cliente actualizado correctamente")
            ...
            if 'conexion' in locals() and conexion.is_connected():
                cursor.close()
            print("Cursor cerrado.")
    def eliminar_cliente(self, id_cliente, nombre, apellido, direccion, telefono):
        try:
            cursor = conexion.cursor()

            consulta = """
            UPDATE clientes
            SET nombre = %s, apellido = %s, direccion = %s, telefono = %s,activo=0
            WHERE id_cliente = %s
            """
            datos = (nombre, apellido, direccion, telefono, id_cliente)
            cursor.execute(consulta, datos)
            ...
            conexion.commit()
            QMessageBox.information(self, "Correcto", "Cliente eliminado correctamente")
